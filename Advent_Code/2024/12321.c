...
int main(){
    ...
    int reports[1024][1024] = { {38, 41, 44, 47, 50, 47},
{75, 78, 79, 82, 85, 85},
{11, 13, 16, 19, 21, 25},
{39, 40, 43, 44, 50},
...
{83, 84, 87, 90, 91, 94, 96, 98},
    ...
    {
        int size = sizeof(reports[i]) / sizeof(reports[i][0]); // me diu les columnes de cada fila
        int checkFile = 0;
    ...
    int size = (sizeof(reports[0]) / sizeof(reports[1][1]));
    printf("%d\n",size);

    printf("El número total de reportes seguros es: %d\n", safe);
